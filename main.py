...
# Add Gaussian Noise:
noisy_5  = add_gaussian_noise(img2, 5)
noisy_10 = add_gaussian_noise(img2, 10)
noisy_15 = add_gaussian_noise(img2, 15)
noisy_25 = add_gaussian_noise(img1, 25)


# Sample 6000 8 cross 8 patches of the image

# Extract training patches
Y_train, locations = sample_patches(noisy_25,patch_size=8,K=6000,seed=0)
print(Y_train.shape)
...
Y_all, all_locations = sample_patches(noisy_25, patch_size=8,K=None)
...
print("Noisy PSNR:",psnr(img1, noisy_25))

print("Denoised PSNR:",psnr(img1, denoised_image))
